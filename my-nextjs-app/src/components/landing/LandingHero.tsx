      ...
      <div className="mx-auto grid max-w-[1200px] items-center gap-14 px-5 pb-16 pt-14 sm:px-8 lg:grid-cols-[1.2fr_0.8fr] lg:pb-20 lg:pt-[88px]">
        ...
        >
          ...
          >
            ...
            <span className="relative inline-block whitespace-nowrap text-[#A05F00]">
              ganze Stadt
              <motion.svg
                aria-hidden
                viewBox="0 0 300 16"
          ...
          >
            Ihre Digitalagentur in Braunschweig: Von schnellen Websites über KI-Integration bis
            zur eigenen Stadt-App entwickeln wir digitale Produkte, auf die sich Unternehmen in
            Braunschweig und der Region verlassen.
          </motion.p>
          ...
          <motion.span variants={item} className="text-sm text-[#7A7365]">
            Bekannt aus{" "}
            <a
